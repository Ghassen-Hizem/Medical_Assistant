export default function SideBar() {
    ...
    return(
        ...
        <>
        <aside class="flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)]">
